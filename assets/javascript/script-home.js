// carrousel clients hideArrowsOnMobile
function startFlowSwitcher() {
    ...
    var t = document.querySelectorAll("#flow-switcher > li"),
        ...
        r = document.querySelectorAll("#flow-boxes .text"), i = document.querySelector("#flow-boxes .codebox-container"), s = document.querySelector("#flow-boxes .boxes"), o = document.querySelector("#flow-boxes .end");
    for (var u = 0; u < t.length; ++u)t[u].addEventListener("mouseover", function (u) {
        u.stopPropagation();
        var a = document.querySelector("#flow-switcher .active"), f = u.target.nodeName == "SPAN" ? u.target.parentNode : u.target;
        if (a == f)return;
        var l = e(a), c = e(f);
